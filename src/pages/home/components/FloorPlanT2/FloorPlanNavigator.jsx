        ...
        {data.floors.map((item, index) => {
          return (
            <button
              ...
              className={`transition-all duration-500 p-2 border-b-2 min-w-32 origin-bottom rounded-2xl rounded-tr-none flex flex-col justify-center items-center cursor-pointer ${
